---
title: Sourdough — everything is temperature times time
source-type: video
url: https://example.com/sourdough
author: Trevor Wilson
tags: [fermentation, process, feedback-loops, baking]
status: read
created: 2026-05-19
---
...
Bulk fermentation is not a duration, it is a target state reached at a rate set
by dough temperature. A recipe that specifies four hours is only correct at the
